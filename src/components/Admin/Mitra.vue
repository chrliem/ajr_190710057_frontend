        ...
        <v-card>
            <v-data-table :headers="headers" :items="mitras" :search="search">
                ...
                <template v-slot:[`item.actions`]="{ item }">
                   ...
                   <v-chip><v-icon color="red" @click="deleteHandler(item.id_mitra)">mdi-delete</v-icon></v-chip>                 
                </template>
            </v-data-table>
        </v-card>
        </v-container>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            ...
            <v-text-field v-model="form.no_telepon_mitra" label="No Telepon Mitra" required></v-text-field> 
